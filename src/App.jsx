            ...
            <main>
                ...
                <div className="Carousel">
                    ...
                    <div className="slick-list" id="slick-list">
                        <button className="slick-arrow slick-prev" id="button-prev" data-button="button-prev" onclick="app.processingButton(event)">
                        ...
                        <div className="slick-hombre" id="track">
                            {
                                 productosHombre.map(
                                    (producto) =>
                                              <div className="slick">
                                                  <a href="">
                                                      <h4><small>{producto.nombre}</small>${producto.precio}</h4>
                                                      <div className="agregar">
                                                          <button className="comprar btn btn-dark" id="${producto.id}"><span className="material-symbols-outlined">
                                                              shop
                                                          </span></button>
                                                          <button className="btn btn-danger"><span className="material-symbols-outlined">
                                                              heart_plus
                                                          </span></button>
                                                      </div>
                                                      <div>
                        ...
                        <button className="slick-arrow slick-next" id="button-next" data-button="button-next" onclick="app.processingButton(event)">
                ...
                <div className="Carousel">
                    ...
                    <div className="slick-list" id="slick-list">
                        ...
                        <div className="slick-mujer" id="track">
                            {
                                productosMujer.map(
                                    (producto) => 
                                <div className="slick">
